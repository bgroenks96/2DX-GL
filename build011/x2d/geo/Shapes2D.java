 ...
 * Graphics object MUST be passed to to an instance of any class that subclasses
 * it so that the figures can be directly painted to the component. Shapes2D is
 * not able to be instantiated, however, its getCanvas() method get can be
 * called by referencing any one of its subclasses.
 */
public abstract class Shapes2D {
	...
	/**
	 * Create this Shapes2D with all of the given attributes.  This implementation just calls setProperties
	 * @param x
	 * @param y
	 * @param size
	 * @param p
