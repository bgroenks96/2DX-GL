...
/**
 * Represents the underlying frame used to display rendered content on screen.
 * Display creates a JFrame used to display a RenderControl's BufferStrategy.
 * This is essentially the entry point for graphics rendering in Snap2D and
 * works tightly in conjunction with RenderControl.
 * 
...
public class Display {
     ...
     * @param type
     */
    public Display(final int width, final int height, final Type type) {

        this(width, height, type, GraphicsConfig.getDefaultSystemConfig());
    }

    /**
     * Creates the Display and initializes Java2D with the given config
     * settings. If <code>config</code> is null, Java's default configuration
     * will be used.
     * 
     * @param width
     ...
     */
    public Display(final int width, final int height, final Type type, final GraphicsConfig config) {
     ...
     */
    public void setDefaultCloseOperation(final int onClose) {
     ...
     * @param dispType
     */
    public void setType(final Type dispType) {
    ...
    /**
     * @return the current size of this Display regardless of whether or not it
     *         is being shown.
     */
    ...
    /**
     * Creates a new RenderControl to be used as a rendering handle for drawing
     * to this Display. This method creates the renderer and adds it to the
     * frame. Call <code>show()</code> to show the Display.
     * 
     * @param buffs
     * @return
     */
    public RenderControl getRenderControl(final int buffs) {
    ...
    /**
     * Shows this Display's frame on screen. If this is a fullscreen window,
     * this method will set the frame to be activated as the system's full
     * screen display view.
     */
    public void show() {
    ...
    /**
     * Hides this Display's frame on screen. If this is a fullscreen window,
     * this method will remove the frame from the system's full screen display
     * view. For windowed mode, this will minimize the window on most desktop
     * environments.
     */
    public void hide() {
    ...
    /**
     * Disposes this Display and its rendering handle (if any). Once disposed, a
     * Display object should be discarded. It's a good idea to call this only
    ...
    public enum Type {
        ...
        /**
         * Only relevant for Type.FULLSCREEN mode. Sets the Display as a native
         * fullscreen window rather than just displaying a screen-sized frame.
         * This feature is especially useful on Windows systems. <br/>
         * <br/>
         * Note: Using this feature will often cause the native graphics driver
         * to enforce settings like vertical-sync or triple buffering on the
         * rendering system.
         * 
         * @param nativeFullscreen
         */
        public void setUseNativeFullscreen(final boolean nativeFullscreen) {
     ...
     * @param rc
     */
    public void show(final RenderControl rc) {
