...
public enum BufferUsage {
    ...
    /**
     * Should be used for data that will be updated frequently (i.e. every few
     * frames). Maps to field GL_DYNAMIC_DRAW.
     */
    DYNAMIC_DRAW(GL.GL_DYNAMIC_DRAW),
    /**
     * Should be used for data that will be updated on every frame. Maps to
     * field GL_STREAM_DRAW.
     */
    STREAM_DRAW(GL2.GL_STREAM_DRAW);

    final int usageHint;

    BufferUsage(final int usage) {
