 ...
 * class will have the Snap2D transform vertex shader prepended to the head of
 * the source string. This means any vertex shaders passed into this class
 * should NOT declare a version string in the shader source file, rather the
...
public class GLShader {
     ...
     */
    public GLShader(final int type, final String... sources) throws GLShaderException, IOException {
     ...
     */
    public GLShader(final int type, final URL... sources) throws GLShaderException, IOException {
    ...
    private void compile(final int type, final String version, final String... sources) throws GLShaderException,
        ...
        if (type == TYPE_VERTEX) {
            ...
            sb.append(loadTransformShaderSource()); // append transform vertex
            // shader source
        }
