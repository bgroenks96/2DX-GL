...
/**
 * Acts as a static entrance point to the Snapdragon2D Sound API. You MUST call the
...
public class SoundAPI {
	...
	/**
	 * Initializes the Snapdragon2D sound system by creating and initializing the static API
	...
	public static void init() {
		...
		try {
			...
			SnapLogger.printErr("failed to initialize Snapdragon2D Sound API: " + e.getMessage(), true);
			sound2d = null;
		}
	}
