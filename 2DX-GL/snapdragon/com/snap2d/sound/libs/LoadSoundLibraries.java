...
/**
 * Class used to load SoundSystem library from local Snapdragon2D jar.  Generally, there should be no need to use this class, as the Snapdragon
 * sound API will take care of doing so.
 * @author Brian Groenke
 *
 */
public class LoadSoundLibraries {

	public static String[] JAR_PATHS = new String[] {"com/snap2d/sound/libs/LibraryJavaSound.jar", "com/snap2d/sound/libs/SoundSystem.jar"};
