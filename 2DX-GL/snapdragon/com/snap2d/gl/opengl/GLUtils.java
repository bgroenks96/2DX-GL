...
public class GLUtils {
	 ...
	 * The passed array is modified directly.
	 * @param rgbaValues
	 * @return the modified array 'rgbaValues'
	 */
	public static final float[] convertColorAwtToGL(float[] rgbaValues) {
		for(int i=0; i < rgbaValues.length; i++)
			rgbaValues[i] = rgbaValues[i] / 255f;
		return rgbaValues;
	}
	
	public static void printBuffer(FloatBuffer buff) {
		System.out.print("[");
