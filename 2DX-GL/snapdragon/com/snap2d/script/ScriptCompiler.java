		...
		for(int i=0;i<chars.length - 1;i++) {
			...
			if(kw != null && isForOperator(kw)) {
				...
				case MINUS_DECREM:
					...
					parseEvaluation(sb.toString(), src, npos, Flags.TYPE_FLOAT);
