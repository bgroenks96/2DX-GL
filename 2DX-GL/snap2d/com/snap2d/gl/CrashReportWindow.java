...
/**
 * A frame that can be shown when an uncaught, usually unrecoverable exception
 * or error is detected by system code in order to show detailed information
 * about the crash. Upon closing of the window, the JVM will be terminated with
...
public class CrashReportWindow extends JFrame {
     ...
     * @param error
     */
    public void dumpToLog(final String message, final Throwable error) {
    ...
    private StringBuilder appendSysInfo(final StringBuilder str) {
