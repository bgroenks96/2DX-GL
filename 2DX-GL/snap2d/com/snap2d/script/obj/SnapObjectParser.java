...
public class SnapObjectParser {
	...
	public SnapObject[] parseFromStream(InputStream in) throws IOException, ScriptObjectParsingException {
	...
	public SnapObject[] parseFromFile(File file) throws IOException, ScriptObjectParsingException {
	...
	private int findEndOfBlock(char[] chars, int pos) {
		int stcount = 0;
