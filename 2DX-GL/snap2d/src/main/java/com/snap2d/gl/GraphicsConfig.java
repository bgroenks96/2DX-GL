...
/**
 * Graphics Library Config - Object that represents configuration data for
 * Java2D rendering.
 * 
...
public class GraphicsConfig {
    ...
    /**
     * Creates a GrahpicsConfig optimized to defaults appropriate for the
     * current system. If the underlying OS is Windows, the default Property
     * values are changed to take advantage of Windows native D3D systems over
     * OpenGL and set other Windows-specific configurations. Otherwise, the
     * default Property values are used (they are, by default, more optimized
     * for Linux/Solaris/Macintosh systems). On Linux systems, if the current
     * Java runtime's version is 1.7 or higher, XRender will be favored over
     * OpenGL.
     * 
     * @return
     */
    public static GraphicsConfig getDefaultSystemConfig() {
        ...
        if (os.contains("windows")) {
            ...
            return config;
        } else if ( (os.contains("linux") || os.contains("nix")) && Local.minJavaVersion(1, 7)) {
    ...
    public enum Property {
         ...
         * Boolean (default=true) <br/>
         * <br/>
         * If true, initialization and modification to the rendering engine
