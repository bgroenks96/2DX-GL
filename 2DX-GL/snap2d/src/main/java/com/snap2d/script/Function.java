...
public class Function implements Comparable<Function> {
    ...
    private int srcOffs;
    private final Keyword[] paramTypes;
     ...
     * 
     * @param name
     *            the string identifier of the function as it appears in the
     *            script
     * @param returnType
     *            the data type returned by this function
     * @param params
     *            the data type of each parameter in order
     * @param paramNames
     *            the variable name of each parameter in order
     * @param src
     *            the script source code for the function - every character
    ...
    /**
     * @return the offset of the function source in the file; -1 for java
     *         functions
     */
    ...
    @Override
    public int compareTo(final Function f) {
