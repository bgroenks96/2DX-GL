 ...
 * <br/>
 * Note: A shutdown hook is added to the system to ensure that sound-based
 * resources are cleaned up properly. You may still shutdown a Sound2D instance
 * at any time. The shutdown hook will simply abort its shutdown operation.
 * 
...
public class SoundAPI {
    ...
    /**
     * Initializes the Snap2D sound system by creating and initializing the
     * static API instance of Sound2D. If SoundAPI has already been initialized
     * and Sound2D has not been shutdown, this method will do nothing and return
     * immediately.
     */
     ...
     * 
     * @param jarPkg
     *            fully qualified path for the package in the JAR file (i.e
     *            com/example/sound/files)
     */
    public static void setSoundFilesPackage(final String jarPkg) {
    ...
    /**
     * Sets the maximum size allowed for files being loaded into the sound
     * system.
     * 
     * @param maxBytes
     */
    public static void setMaxFileSize(final int maxBytes) {
     ...
     * Streaming channels are created first, so the more higher number created
     * the fewer normal channels that will be available. Some libraries may
     * require that the total number of channels (streaming + non-streaming) =
     * 32
     * 
     * @param num
     *            number of standard audio channels
     */
    public static void setMaxNormalChannels(final int num) {
     ...
     * 
     * @param num
     *            number of streaming audio channels
     */
    public static void setMaxStreamingChannels(final int num) {

        SoundSystemConfig.setNumberStreamingChannels(num);
    }

    /**
     * Fetches the initialized sound system handle Sound2D for the Snap2D Sound
     * API.
     * 
