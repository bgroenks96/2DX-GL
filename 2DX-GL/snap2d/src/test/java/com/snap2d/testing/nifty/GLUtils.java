...
public class GLUtils {
    ...
    public static final ByteBuffer newDirectByteBuffer(final byte... bytes) {

        return Buffers.newDirectByteBuffer(bytes);
    }

    public static final IntBuffer newDirectIntBuffer(final int... ints) {

        return Buffers.newDirectIntBuffer(ints);
    }

    public static final FloatBuffer newDirectFloatBuffer(final float... floats) {

        return Buffers.newDirectFloatBuffer(floats);
    }

    public static final DoubleBuffer newDirectDoubleBuffer(final double... doubles) {

        return Buffers.newDirectDoubleBuffer(doubles);
    }

    public static final CharBuffer newDirectCharBuffer(final char... chars) {

        return Buffers.newDirectCharBuffer(chars);
    }

    public static final ShortBuffer newDirectShortBuffer(final short... shorts) {
     ...
     * @param colorBuff
     *            a FloatBuffer with capacity/limit >= 4
     * @return
     */
    public static final FloatBuffer writeColorToBuffer(final Color color, final FloatBuffer colorBuff) {
     ...
     * @return
     */
    public static final FloatBuffer writeColorToNewBuffer(final Color color) {
     ...
     */
    public static final float[] convertColorAwtToGL(final Color color) {
    ...
    public static final void printBuffer(final FloatBuffer buff) {
    ...
    public static final float[] readAvailable(final FloatBuffer buff, final float[] dest) {
    ...
    static int glGetInteger(final GL gl, final int pint) {
    ...
    static float glGetFloat(final GL gl, final int pname) {
    ...
    static boolean glGetBoolean(final GL gl, final int pname) {
