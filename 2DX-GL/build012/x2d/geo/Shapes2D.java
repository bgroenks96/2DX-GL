 ...
 * Shapes2D in the geometry package are generally pre-defined, regular shapes (drawn using rotations).  The shape and all of its attributes are
 * created when the constructor is invoked but not drawn until <code>draw(Graphics2D)</code> is called.
 */
