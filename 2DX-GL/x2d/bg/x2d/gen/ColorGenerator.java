...
public class ColorGenerator implements Generator<Color> {
	...
	private NumberGenerator<Integer> numGen = new NumberGenerator<Integer>(0, 255);
	
	/**
	 * Creates a ColorGenerator that will randomly generate the components selected
	 * via <code>genChannels</code>
	 * @param genChannels a bitmask OR of the desired color components
	 * @see {@link #RED} {@link #GREEN} {@link #BLUE} {@link #ALPHA}
	 */
	public ColorGenerator(int genChannels) {
		this.channels = genChannels;
	}
	
	public void setDefaultRGBA(int r, int g, int b, int a) {
