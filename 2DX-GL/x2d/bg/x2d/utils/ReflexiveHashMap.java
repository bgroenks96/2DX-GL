...
/**
 * Allows for reflexive Map modification between two recursively mapped values.  Each put
 * operation adds the key to an internal HashMap that maps value->key (type <V2,V1>).
 * 
