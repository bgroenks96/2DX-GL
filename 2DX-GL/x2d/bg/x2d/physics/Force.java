...
public abstract class Force {
    ...
    /**
     * Sets the vector for this force. A vector may hold different meanings
     * depending on the force; i.e a force vector might be acceleration, energy,
     * etc. or just straight force in Newtons.
     * 
     * @param vec
    ...
    /**
     * Implementation dependent. Standard implementation for a Newton force will
     * simply return the Force's value regardless of the value of
     * <code>mass</code>. Some forces like Gravity may compute this value using
     * F = ma.
     * 
     * @param mass
    ...
    /**
     * Implementation dependent. Standard implementation for a Newton force will
     * compute this value using F = ma. Gravity, on the other hand, will behave
     * as a field and accelerate all masses the same regardless of mass.
     * 
     * @param mass
     ...
     *            of the object in Kg
     * @param forceSum
     *            some Forces may require a sum of other forces also being
     *            applied at at the current time interval. This argument is
     *            optional, thus all implementations should account for possible
     *            null values.
     * @param vec
