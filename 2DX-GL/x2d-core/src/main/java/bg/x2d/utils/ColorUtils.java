...
public class ColorUtils {
    ...
    public static int packInt(final int... rgbs) {

        if (rgbs.length != 3 && rgbs.length != 4) {
            throw (new IllegalArgumentException("args must be valid RGB, ARGB or RGBA value."));
        }
     ...
     * @return
     */
    public static int[] getImageData(final BufferedImage bi) {
