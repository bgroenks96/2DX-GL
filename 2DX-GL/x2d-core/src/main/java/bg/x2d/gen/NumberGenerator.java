...
public class NumberGenerator<T extends Number> implements Generator<T> {
    ...
    public NumberGenerator(final T min, final T max) throws IllegalArgumentException {

        setBounds(min, max);
    }

    public NumberGenerator(final T min, final T max, final long seed) throws IllegalArgumentException {

        rand.setSeed(seed);
    }

    public void setBounds(final T min, final T max) throws IllegalArgumentException {
