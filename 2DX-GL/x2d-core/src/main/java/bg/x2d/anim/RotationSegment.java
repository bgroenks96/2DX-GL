...
public class RotationSegment implements Segment {
     ...
     *            drawn objects).
     */
    public RotationSegment(final int deltaTheta, final long duration, final Point2D anchor) {
     ...
     */
    public RotationSegment(final int deltaTheta, final long duration) {
