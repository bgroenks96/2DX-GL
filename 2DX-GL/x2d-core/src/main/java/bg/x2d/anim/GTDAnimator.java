...
/**
 * The base GTD animation engine provided by the 2DX-GL library. Users are
 ...
 * <br>
 * GTD (Graphical Task Distribution) Animator submits its tasks to the
 ...
 */
public abstract class GTDAnimator implements Animator {
     ...
     */
    @Override
    public void drawFrame(final Graphics2D g2) {
     ...
     */
    public synchronized void register(final Drawable d) {
     ...
     */
    public synchronized boolean decommission(final Drawable d) {
