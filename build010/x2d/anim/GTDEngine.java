 ...
 * <br>
 * <br>
 * GTD (Graphical Task Distribution Engine) submits its tasks to the AWTEventQueue to be executed in order to avoid concurrent graphics modification and adhere to Sun's recommended AWT/Swing programming behavior.  
 * To ensure the best performance possible, it is recommended that you avoid submitting other tasks to the AWTEventQueue while animating, so that the AWT thread can execute graphical tasks 
 * can be completed as quickly as possible.
 * <br>
 * <br>
 * <b>Note: Do not use SwingUtilities.invokeAndWait() (or any other blocking method) in any Drawable objects passed to an GTDEngine.<b>
 * @author Brian
