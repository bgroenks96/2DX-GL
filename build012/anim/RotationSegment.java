...
/**
 * Segment that rotates the AffineTransform a specified number of degrees, over a specified amount of time and around
...
public class RotationSegment implements Segment {
	...
	/**
	 * Creates a new RotationSegment that rotates <code>deltaTheta</code> degrees for <code>duration</code> milliseconds around
	 * <code>anchor</code> point.
	 * @param deltaTheta the total degrees to rotate
	 * @param duration the total time duration for the segment
	 * @param anchor anchor point for the rotation; if null, the Graphics object default anchor will be used (usually the x,y coordinate of drawn objects).
	 */
	...
	/**
	 * Returns the total degrees rotated in this Segment.
	 */
	@Override
