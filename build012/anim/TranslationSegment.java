...
/**
 * Segment that translates the AffineTransform the specified amounts on the x and y axes for the specified amount of time.
...
public class TranslationSegment implements Segment {
	...
	/**
	 * Creates a new TranslationSegment that translates <code>deltax</code> accross the x axis and <code>deltay</code> on the y axis.
	 * @param deltax amount to translate on the x axis
	 * @param deltay amount to translate on the y axis
	 * @param duration total time duration of the Segment
	 */
	...
	/**
	 * This implementation returns the magnitude of the vector formed by delta x and delta y (aka the hypotenuse).
	 */
	@Override
