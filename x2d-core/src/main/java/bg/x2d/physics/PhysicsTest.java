...
public class PhysicsTest extends JApplet {
    ...
    class PhysicsPanel extends JPanel {
        ...
        private void checkCollision(final Entity e, final float time) {

            /*
             * if(!view.worldContains(e.getWorldBounds())) {
             * e.pnode.collide((float)collFrac); Rectangle2D rect =
             * view.moveInBounds(e.getWorldBounds()); e.setWorldLoc(rect.getX(),
             * rect.getY()); }
             */
    ...
    private class Entity {
        ...
        Entity(final PhysicsNode node, final PointUD worldLoc, final WorldView viewport, final int size) {
        ...
        public void setWorldLoc(final double x, final double y) {

            worldLoc.setLocation(x, y);
            screenLoc = view.worldToScreen(worldLoc);
        }

        public void setScreenLoc(final int x, final int y) {
    ...
    class WorldView {
        ...
        WorldView(final float xmin, final float ymin, final float xmax, final float ymax) {
        ...
        public void reposition(final float xmin, final float ymin, final float xmax, final float ymax) {
        ...
        public Point worldToScreen(final Point p) {
        ...
        public PointUD screenToWorld(final Point p) {
        ...
        public boolean worldContains(final Rectangle2D r) {
    ...
    class SettingsDialog extends JDialog implements ActionListener {
        ...
        String[] textFieldNames = new String[] { "mass", "ppm", "size", "collFrac", "frictionStatic",
                "frictionKinetic", "sleepTime" };
